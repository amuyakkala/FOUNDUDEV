...
<head>
    <title>Code coverage report for lib/commands/help.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/commands</a> help.js</h1>
        <div class='clearfix'>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (help.aliases &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >help.aliases.length &gt; 0)</span> {
<span class="cstat-no" title="statement not covered" >          content.push(`\n${chalk.bold('Aliases:')} ${help.aliases.join(', ')}`);</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (help.options &amp;&amp; help.options.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >          content.push(`\n${chalk.bold('Options:')}\n${help.options.join('\n')}`);</span>
        }
&nbsp;
        content.push(`\n${chalk.bold('Examples:')}\n${help.examples.map(ex =&gt; `  ${ex}`).join('\n')}`);
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (help.details) {
          content.push(`\n${chalk.bold('Details:')}\n${help.details}`);
        }
&nbsp;
...
&nbsp;
module.exports = helpCommand;</pre></td></tr></table></pre>
